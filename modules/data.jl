module Data
    ...
    function process_psrdata_16(indir, outdir; files=nothing, outfile="pulsar.spCf16", params_file="params.json")
        ...
        Plot.single(folded_low, outdir; darkness=0.9, number=nothing, bin_st=p["bin_st"], bin_end=p["bin_end"], start=1, name_mod="p3fold_low", show_=false, repeat_num=4)
        ...
        Plot.p3fold(d5, outdir; start=1, bin_st=p["bin_st"]-20, bin_end=p["bin_end"]+20, darkness=0.9, name_mod="pulsar_low", show_=true, repeat_num=4)
        ...
        d5 = Data.load_ascii(replace(high_debase, ".gg"=>".p3fold"))
        Plot.p3fold(d5, outdir; start=1, bin_st=p["bin_st"]-20, bin_end=p["bin_end"]+20, darkness=0.9, name_mod="pulsar_high", show_=true, repeat_num=4)
