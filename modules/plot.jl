module Plot
    ...
    function average(data, outdir; start=1, number=100, bin_st=nothing, bin_end=nothing, name_mod="0", show_=true)
        num, bins = size(data)
        if number == nothing
    ...
    function single(data, outdir; start=1, number=100, cmap="viridis", bin_st=nothing, bin_end=nothing, darkness=0.5, name_mod="PSR_NAME", show_=true)
        num, bins = size(data)
        if number == nothing
            number = num - start  # missing one?
        end
    ...
    function lrfs(data, outdir; start=1, number=nothing, cmap="viridis", bin_st=nothing, bin_end=nothing, darkness=0.5, name_mod="0", change_fftphase=true, show_=true)
    ...
    function p3fold(data, outdir; start=1, number=nothing, repeat_num=4, cmap="inferno", bin_st=nothing, bin_end=nothing, darkness=0.5, name_mod="0", show_=)
        num, bins = size(data)
        if number == nothing
            number = num - start  # missing one?
        end
