module SpaTs
    ...
    function repuls(vpmout::String, num_files::Int)
        ...
        Plot.average(combined_data, outdir; number=nothing, bin_st=400, bin_end=600, start=1, name_mod="J1319", show_=true)
        Plot.lrfs(combined_data, outdir; darkness=0.1, start=1, name_mod="J1319", bin_st=400, bin_end=600, show_=true)
