module SpaTs
    ...
    """
    Loads 2DFS data generated by PSRSALSA's pspec
    Returns: 2D array containing the 2DFS data
    """
    function load_2dfs(filename)
        ...
        for i in 1:nx
            ...
            values = split(line)
            for j in 1:ny
                data[i,j] = parse(Float64, values[j])
            end
        end
    ...
    function main()
        ...
        data = load_2dfs("/home/psr/output/pulsar.debase.1.2dfs")
        println(size(data))
    end
