module SpaTs
    ...
    function fold_test(outdir)
        ...
        Plot.single(data, outdir; darkness=0.5, number=nothing, bin_st=450, bin_end=550, start=1, name_mod="test", show_=true)
        Plot.lrfs(data, outdir; darkness=0.1, start=1, name_mod="test", bin_st=450, bin_end=550, show_=true)
        folded = Tools.fold_single(data, 20, 40)
